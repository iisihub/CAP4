 ...
 *          </ul>
 */
public class MOMNamedJdbcTemplate extends CapNamedJdbcTemplate {
    ...
    public MOMNamedJdbcTemplate(DataSource dataSource) {
        super(dataSource);
    }
    ...
    public void query(String sqlId, Map<String, ?> args, RowCallbackHandler rch) {
        StringBuffer sql = new StringBuffer(sqlp.getValue(sqlId, sqlId));
    ...
    public <T> List<T> query(String sqlId, String appendDynamicSql, Map<String, Object> args, int startRow, int fetchSize, RowMapper<T> rm) {
        ...
        long cur = System.currentTimeMillis();
        try {
            return namedjdbc.query(sql.toString(), args, new CapRowMapperResultSetExtractor<T>(rm, startRow, fetchSize));
        } catch (Exception e) {
            throw new CapDBException(e, causeClass);
        } finally {
            logger.info("CapNamedJdbcTemplate spend {} ms", (System.currentTimeMillis() - cur));
    ...
    public <T> List<T> query(String sqlId, String appendDynamicSql, Map<String, ?> args, RowMapper<T> rm) {
        ...
        long cur = System.currentTimeMillis();
        try {
            return namedjdbc.query(sql.toString(), (Map<String, Object>) args, new RowMapperResultSetExtractor<T>(rm));
        } catch (Exception e) {
            throw new CapDBException(e, causeClass);
        } finally {
            logger.info("CapNamedJdbcTemplate spend {} ms", (System.currentTimeMillis() - cur));
    ...
    public int queryForInt(String sqlId, Map<String, ?> args) {
        ...
        long cur = System.currentTimeMillis();
        try {
            return (int) namedjdbc.queryForObject(sql.toString(), (Map) args,
                    Integer.class);
        } catch (Exception e) {
            throw new CapDBException(e, causeClass);
        } finally {
    ...
    public int update(String sqlId, Map<String, ?> args) {
        ...
        long cur = System.currentTimeMillis();
        try {
            return namedjdbc.update(sql, args);
        } catch (Exception e) {
            throw new CapDBException(e, causeClass);
        } finally {
            logger.info("CapNamedJdbcTemplate spend {} ms", (System.currentTimeMillis() - cur));
    ...
    public int batchUpdate(String sqlId, Map<String, Integer> sqlTypes, final List<Map<String, Object>> batchValues) {
        ...
        try {
            ...
            if (sqlTypes != null && !sqlTypes.isEmpty()) {
                ...
                batchCount = NamedParameterBatchUpdateUtils.executeBatchUpdateWithNamedParameters(parsedSql, batch, namedjdbc.getJdbcOperations());
    ...
    public List<Map<String, Object>> queryPaging(String sqlId, Map<String, Object> args, int startRow, int fetchSize) {
        ...
        params.put(CapJdbcConstants.SQL_PAGING_QUERY, getSourceSql(sqlId, args, startRow, fetchSize));
        ...
        sql.append(' ').append(sqltemp.getValue(CapJdbcConstants.SQL_PAGING_QUERY, ""));
        if (args == null) {
    ...
    public Page<Map<String, Object>> queryForPage(String sqlId, Map<String, Object> args, int startRow, int fetchSize) {
        ...
        long cur = System.currentTimeMillis();
        try {
            return new Page<Map<String, Object>>(list, namedjdbc.queryForObject(sql.toString(), args, Integer.class), fetchSize, startRow);
        } catch (Exception e) {
            throw new CapDBException(e, causeClass);
        } finally {
            logger.info("CapNamedJdbcTemplate spend {} ms", (System.currentTimeMillis() - cur));
    ...
    public Page<Map<String, Object>> queryForPage(String sqlId, String sqlId_prefix, Map<String, Object> args, int startRow, int fetchSize) {

        Map<String, Object> params = new HashMap<String, Object>();
        params.put(CapJdbcConstants.SQL_PAGING_SOURCE_SQL, getSourceSql(sqlId, args, startRow, fetchSize));
        StringBuffer sql = new StringBuffer().append(CapCommonUtil.spelParser((String) sqltemp.getValue(CapJdbcConstants.SQL_PAGING_TOTAL_PAGE), params, sqlp.getParserContext()));
        sql.append(' ').append(sqltemp.getValue(CapJdbcConstants.SQL_QUERY_SUFFIX, ""));
        sql.insert(0, sqltemp.getValue(sqlId_prefix, "") + " ");

        if (logger.isTraceEnabled()) {
            logger.trace(new StringBuffer("\n\t").append(CapDbUtil.convertToSQLCommand(sql.toString(), args)).toString());
        }
        // find list
        List<Map<String, Object>> list = this.queryPaging(sqlId, sqlId_prefix, args, startRow, fetchSize);
        long cur = System.currentTimeMillis();
        try {
            return new Page<Map<String, Object>>(list, namedjdbc.queryForObject(sql.toString(), args,Integer.class), fetchSize, startRow);
        } catch (Exception e) {
    ...
    public List<Map<String, Object>> queryPaging(String sqlId, String sqlId_prefix, Map<String, Object> args, int startRow, int fetchSize) {
    ...
    public String getSql(String sqlId, Map<String, Object> args) {
        if (sqltemp.containsKey(sqlId)) {
            return CapCommonUtil.spelParser(sqltemp.getValue(sqlId, sqlId), args, sqltemp.getParserContext());
        } else {
    ...
    public Page<Map<String, Object>> queryForPage(String sqlId, SearchSetting search) {
        ...
        long cur = System.currentTimeMillis();
        try {
            int totalRows = namedjdbc.queryForObject(sqlRow, provider.getParams(), Integer.class);
            List<Map<String, Object>> list = namedjdbc.queryForList(sql.toString(), provider.getParams());
    ...
    public <T> Page<T> queryForPage(String sqlId, SearchSetting search, RowMapper<T> rm) {
        ...
        try {
            int totalRows = namedjdbc.queryForObject(sqlRow, provider.getParams(), Integer.class);
            List<T> list = namedjdbc.query(sql.toString(), provider.getParams(), rm);
