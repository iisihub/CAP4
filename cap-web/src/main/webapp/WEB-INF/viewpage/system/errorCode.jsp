        ...
        <div id="qryDialog" style="display: none">
            <form id="qform">
                <table class="row-data" width="99%" border="0" cellspacing="0" cellpadding="0" id="searchTable">
                    <tbody>
                        <tr>
                            <td width="40%" class="hd1"><spring:message code="js.errorCode.code"></spring:message></td>
                            <td width="60%"><input type="text" size="20" id="code" name="code" maxlength="20" /></td>
                        </tr>
                        <tr>
                            <td class="hd1"><spring:message code="js.errorCode.locale"></spring:message></td>
                            <td><select id="locale" name="locale" combokey="lang"></select></td>
                        </tr>
                        <!-- 
                        <tr>
                            <td class="hd1"><spring:message code="js.errorCode.sysId"></spring:message></td>
                            <td>
        ...
        <div id="editDialog" style="display: none">
            <form id="eform">
                <table class="row-data" width="99%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            <td width="20%" class="hd1"><span class="color-red">＊</span> <spring:message code="js.errorCode.code"></spring:message></td>
                            <td width="30%"><input type="text" size="20" id="code" name="code" maxlength="20" class="validate[required]" /></td>
                            <td width="20%" class="hd1"><span class="color-red">＊</span> <spring:message code="js.errorCode.locale"></spring:message></td>
                            <td width="30%"><select id="locale" name="locale" combokey="lang" space="true" class="validate[required]"></select></td>
                        </tr>
                        <tr>
                            <!-- 
                            <td width="20%" class="hd1">
                                <span class="color-red">＊</span><spring:message code="js.errorCode.sysId"></spring:message></td>
                            <td width="30%">
                                <select id="sysId" name="sysId" combokey="subsystem" space="true" class="validate[required]"></select>
                            </td>
                             -->
                            <td width="20%" class="hd1"><span class="color-red">＊</span> <spring:message code="js.errorCode.severity"></spring:message></td>
                        ...
                        <tr>
                            <td width="20%" class="hd1"><span class="color-red">＊</span> <spring:message code="js.errorCode.message"></spring:message></td>
                            <td colspan="3"><textarea type="text" rows="5" cols="50" id="message" name="message" maxlength="512" class="validate[required]"></textarea></td>
                        </tr>
                        <tr>
                            <td width="20%" class="hd1"><spring:message code="js.errorCode.suggestion"></spring:message></td>
                            <td colspan="3"><textarea id="suggestion" name="suggestion" rows="5" cols="50"></textarea></td>
                        </tr>
                        <!-- 
                        <tr>
                            <td width="20%" class="hd1"><spring:message code="js.errorCode.sendmon"></spring:message></td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td width="20%" class="hd1"><spring:message code="js.errorCode.helpurl"></spring:message></td>
                            <td colspan="3">
