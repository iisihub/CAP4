...
<body>
	...
	<form name="myform">
	<input type="button" name="mybutton1" value="getVersion" onClick="getVersion()">  
	APIVersion:  <input type="text" name ="ServiceVersion" value="" size=18>  <br> 
	--------------SetTokenType------------------------- <br>  
	<input type="text" name ="tokenType" value="2" size=3>
	<input type="button" name="mybutton2" value="SetTokenType" onClick="settokentype()"> 
	ret<input name ="retSetTokenType" value=""  size=6> <br> 	
	--------------GetCardStatus------------------------- <br> 
	<input type="button" name="mybutton3" value="GetCardStatus" onClick="getCardStatus()">
	ret<input name ="retGetCardStatus" value=""  size=6><br>	
	--------------GetCardType--------------------------- <br>
	<input type="button" name="mybutton4" value="GetCardType" onClick="getCardType()">
	ret<input name ="retGetCardType" value=""  size=6><br>	
	--------------GetGPKICardNo----------------------- <br> 
	<input type="button" name="mybutton5" value="GetGPKICardNo" onClick="getGPKICardNo()">
    ...
    <input type="button" name="mybutton6" value="Login" onClick="login()">
	...
	<input type="button"name="ChangePIN"  value="ChangePIN" onclick="changePIN()">
	ret<input name ="retChangePIN" value="" size=6 ><br>
	--------------Logout---------------------------------- <br>
	<input type="button" name="LogoutBtn" value="Logout" onclick="logout()">
	ret<input name ="retLogout" value="" size=6><br>	
	--------------SelectCert------------------------------ <br>
	CertType<input name="SelectCert_CertType" value="1" size=4> 
	<input type="button" value="SelectCert" name="SelectCert" onclick="selectCert()">
	ret<input name ="retSelectCert" value="" size=6><br>	
			...
			<input type="button" value="SignPKCS7" name="SignPKCS7" onclick="signPKCS7()">
			...
			<input type="button" value="VerifyPKCS7" name="VerifyPKCS7" onclick="verifyPKCS7()">
			ret<input name ="retVerifyPKCS7" value="" size=6><br>	
			ErrorMsg<input name ="ErrorMsg" value="" size=60>
   </form>  
