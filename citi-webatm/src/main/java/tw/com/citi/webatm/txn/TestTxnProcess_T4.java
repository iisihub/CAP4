...
public class TestTxnProcess_T4 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn02.setTransactionType(TxnProcess02.TransactionType_Payment);
            txn02.setIssuerBankCode("021");
            txn02.setIssuerAccount("5304884510");
            txn02.setPCode("2580");
            txn02.setSourceAccount("5304884510");
            txn02.setDestBankCode("021");
            txn02.setDestAccount("5304884501");
            txn02.setTxnAmount("450");
            txn02.setICCTxnNo("610");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_T4 test = new TestTxnProcess_T4();
        for (int i = 0; i < 50; i++) {
