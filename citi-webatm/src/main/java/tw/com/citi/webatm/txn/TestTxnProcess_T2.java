...
public class TestTxnProcess_T2 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn02.setIssuerAccount("0100223910");
            txn02.setPCode("2580");
            txn02.setSourceAccount("0100223910");
            txn02.setDestBankCode("021");
            txn02.setDestAccount("0100188996");
            txn02.setTxnAmount("300");
            txn02.setICCTxnNo("579");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_T2 test = new TestTxnProcess_T2();
        for (int i = 0; i < 1; i++) {
