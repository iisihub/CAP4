...
public class TestTxnProcess_01_BOOC implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn01.setIssuerBankCode("010");
            txn01.setIssuerAccount("0000200254000010"); // for log in txnlog
            txn01.setPCode("2590");
            txn01.setSourceAccount("0000200254000010");
            txn01.setICCTxnNo("26");
            txn01.setICCRemark("303032303032353430303030313030313030303030303030302020202020");
            txn01.setTmlCheckCode("00000000");
            txn01.setTmlType("6534");
            txn01.setTAC("2873A24D8810E420");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_01_BOOC test = new TestTxnProcess_01_BOOC();
        for (int i = 0; i < 1; i++) {
