...
public class TestTxnProcess implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn01.setIssuerAccount("0000000100223910"); // for log in txnlog
            txn01.setPCode("2590");
            txn01.setSourceAccount("0000000100223910");
            txn01.setICCTxnNo("00000499");
            txn01.setICCRemark("B5887850083174560D491212060620213F01AD8F8F8F49ABEFADBC9D9875");
            txn01.setTmlCheckCode("12341234");
            txn01.setTmlType("6534");
            txn01.setTAC("1414DD28029CC6DC");
             ...
             * txn02.setTxnAmount("200"); txn02.setICCTxnNo("00000546"); txn02.setICCRemark("B5887850083174560D491212060620213F01AD8F8F8F49ABEFADBC9D9875"); txn02.setTmlCheckCode("00000000");
             * txn02.setTmlType("6534"); txn02.setTAC("A14F9ABBBD327646"); txn02.setMAC("30303030303030303030303030303030"); txn02.setSessionID("1laskjdfiuo23i9120310923");
             * txn02.setClientIP("255.255.255.0"); txn02.setClientDT("20080707120000"); txn02.doTxn(); /* TxnProcess03 txn03 = new TxnProcess03(txn); txn03.setOnUsCard(true);
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess test = new TestTxnProcess();
        for (int i = 0; i < 1; i++) {
