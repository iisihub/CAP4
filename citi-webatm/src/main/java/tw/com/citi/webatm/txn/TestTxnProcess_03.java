...
public class TestTxnProcess_03 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn01.setOnUsCard(false);
            // txn01.setICCSEQ("00000499");
            txn01.setIssuerBankCode("052");
            txn01.setIssuerAccount("0000320003059673"); // for log in txnlog
            txn01.setPCode("2500");
            txn01.setSourceAccount("0000320003059673");
            txn01.setICCTxnNo("00000499");
            txn01.setICCRemark("343133313330333133333332333733353334333733303330333333303331");
            txn01.setTmlCheckCode("00000000");
            txn01.setTmlType("6534");
            txn01.setTAC("1A6521A84CB2DA5A");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_03 test = new TestTxnProcess_03();
        for (int i = 0; i < 1; i++) {
