...
public class TestTxnProcess_E64 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn03.setDestAccount("1234567890123456");
            txn03.setTxnAmount("500");
            txn03.setICCTxnNo("622");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_E64 test = new TestTxnProcess_E64();
        for (int i = 0; i < 1; i++) {
