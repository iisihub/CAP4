...
public class TestTxnProcess_T3 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn02.setDestAccount("0100223910");
            txn02.setTxnAmount("850");
            txn02.setICCTxnNo("606");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_T3 test = new TestTxnProcess_T3();
        for (int i = 0; i < 1; i++) {
