...
public class TestTxnProcess_CSA_CCA implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn02.setTxnAmount("400");
            txn02.setICCTxnNo("701");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_CSA_CCA test = new TestTxnProcess_CSA_CCA();
        for (int i = 0; i < 1; i++) {
