...
public class TestTxnProcess_E2 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn03.setDestAccount("0000006000278678");
            txn03.setTxnAmount("700");
            txn03.setICCTxnNo("611");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_E2 test = new TestTxnProcess_E2();
        for (int i = 0; i < 1; i++) {
