...
public class TestTxnProcess_E62 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn03.setDestAccount("11000199100121");
            txn03.setTxnAmount("855");
            txn03.setICCTxnNo("620");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_E62 test = new TestTxnProcess_E62();
        for (int i = 0; i < 1; i++) {
