...
public class TestTxnProcess_T1 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn02.setTxnAmount("800");
            txn02.setICCTxnNo("560");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_T1 test = new TestTxnProcess_T1();
        for (int i = 0; i < 1; i++) {
