...
public class TestTxnProcess_E4 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn03.setOnUsCard(true);
            txn03.setTransactionType(TxnProcess03.TransactionType_Transfer);

            // txn03.setICCSEQ("00000685");
            txn03.setIssuerBankCode("021");
            txn03.setIssuerAccount("0000000100223910");
            txn03.setPCode("2521");
            txn03.setSourceAccount("0000000100223910");
            txn03.setDestBankCode("012");
            txn03.setDestAccount("0000200168000030");
            txn03.setTxnAmount("400");
            txn03.setICCTxnNo("632");
            txn03.setICCRemark("B5887850083174560D491212060620213F01AD8F8F8F49ABEFADBC9D9875");
            txn03.setTmlCheckCode("00000000");
            txn03.setTmlType("6534");
            txn03.setTAC("1414DD28029CC6DC");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_E4 test = new TestTxnProcess_E4();
        for (int i = 0; i < 1; i++) {
