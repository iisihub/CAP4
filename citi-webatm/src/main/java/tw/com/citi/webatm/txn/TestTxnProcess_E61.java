...
public class TestTxnProcess_E61 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn03.setIssuerAccount("0100223910");
            txn03.setPCode("2561");
            txn03.setSourceAccount("0100223910");
            txn03.setDestBankCode("861");
            txn03.setDestAccount("123201111011571");
            txn03.setTxnAmount("1200");
            txn03.setICCTxnNo("633");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_E61 test = new TestTxnProcess_E61();
        for (int i = 0; i < 1; i++) {
