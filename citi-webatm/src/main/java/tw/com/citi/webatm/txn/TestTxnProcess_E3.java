...
public class TestTxnProcess_E3 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn03.setDestAccount("0000006000278240");
            txn03.setTxnAmount("375");
            txn03.setICCTxnNo("612");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_E3 test = new TestTxnProcess_E3();
        for (int i = 0; i < 1; i++) {
