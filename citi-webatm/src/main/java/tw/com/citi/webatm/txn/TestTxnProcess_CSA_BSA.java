...
public class TestTxnProcess_CSA_BSA implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn02.setDestAccount("0000200254000010");
            txn02.setTxnAmount("850");
            txn02.setICCTxnNo("681");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_CSA_BSA test = new TestTxnProcess_CSA_BSA();
        for (int i = 0; i < 1; i++) {
