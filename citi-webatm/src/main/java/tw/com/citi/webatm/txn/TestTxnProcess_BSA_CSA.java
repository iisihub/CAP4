...
public class TestTxnProcess_BSA_CSA implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn02.setIssuerBankCode("010");
            txn02.setIssuerAccount("0009978552067388");
            txn02.setPCode("2580");
            txn02.setSourceAccount("0009978552067388");
            txn02.setDestBankCode("021");
            txn02.setDestAccount("0000000100223910");
            txn02.setTxnAmount("555");
            txn02.setICCTxnNo("40");
            txn02.setICCRemark("3039393738353532303637333838303130303030303030302020202020");
            txn02.setTmlCheckCode("00000000");
            txn02.setTmlType("6534");
            txn02.setTAC("09EC9D53DBC8D8FD");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_BSA_CSA test = new TestTxnProcess_BSA_CSA();
        for (int i = 0; i < 1; i++) {
