...
public class TestTxnProcess_02 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn01.setIssuerAccount("5304884504"); // for log in txnlog
            txn01.setPCode("2590");
            txn01.setSourceAccount("5304884504");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_02 test = new TestTxnProcess_02();
        for (int i = 0; i < 1; i++) {
