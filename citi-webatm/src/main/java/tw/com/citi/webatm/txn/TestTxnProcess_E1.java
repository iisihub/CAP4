...
public class TestTxnProcess_E1 implements Runnable {
    ...
    public void run() {
        try {
            ...
            txn03.setDestBankCode("021");
            txn03.setDestAccount("0000000100223910");
            txn03.setTxnAmount("250");
            txn03.setICCTxnNo("610");
    ...
    public static void main(String[] args) {
        ...
        TestTxnProcess_E1 test = new TestTxnProcess_E1();
        for (int i = 0; i < 1; i++) {
