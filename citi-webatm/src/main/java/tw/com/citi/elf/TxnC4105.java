...
import static com.iisigroup.colabase.webatm.common.CCConstants.EncryptionKeyRequest_MsgCode;
...
/**
 * implementation 4105... to build ByteBuffer for RequestData and deconstruct ResponseData from TcpClient include main function...ConstructBBMsg, Deconstruct
 */
public class TxnC4105 extends TxnMain {
    // log4J category
    protected final Logger LOG = LoggerFactory.getLogger(getClass());

    private static final String sEncryType_ID = Integer.toHexString(10092); // TxnC4105
    private static final String sEncryCounter_ID = Integer.toHexString(7932);// "7932"; //TxnC4105
    ...
    private static final String MsgFunCode = EncryptionKeyRequest_MsgCode;
    ...
    private static final String EncryCounter = new String(Misc.bin2Hex("0001".getBytes())); // "0001";
    private static final String EncryType = new String(Misc.bin2Hex("02".getBytes())); // "2";
    ...
    public TxnC4105(String TerminalID, String msgSeq) {
    ...
    public ByteBuffer ConstructBBMsg() {
        ...
        iTempLen1 += iElementLen;
        {
            ...
            iTempLen2 += iElementLen;
            {
                ...
                iElementLen = 4 + 4;
                sbSendMsg.append(sEncryCounter_ID);
                sbSendMsg.append(Misc.padZero(Integer.toHexString(iElementLen), iPadZeroLen));
                sbSendMsg.append(EncryCounter);
                iTempLen1 += iElementLen;
                iTempLen2 += iElementLen;
                iTempLen3 += iElementLen;

                iElementLen = 4 + 2;
                sbSendMsg.append(sEncryType_ID);
                sbSendMsg.append(Misc.padZero(Integer.toHexString(iElementLen), iPadZeroLen));
                sbSendMsg.append(EncryType);
                iTempLen1 += iElementLen;
                iTempLen2 += iElementLen;
                iTempLen3 += iElementLen;
            }
    ...
    public static void main(String[] args) {
        ...
        TxnC4105 txn = new TxnC4105("8614", "00000001");
        txn.ConstructBBMsg();

        String receiveMsg = "00010048000D001364000030303030303121A6FFFFFFFF000500311009002D1EF0000610091F42000621A61F450008FFFFFFFF1F410005301C84000930303030301C860007323030";
