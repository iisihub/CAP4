...
import static com.iisigroup.colabase.webatm.common.CCConstants.InterCitiPinChange_MsgCode;
...
/**
 * implementation 4113... to build ByteBuffer for RequestData and deconstruct ResponseData from TcpClient include main function...ConstructBBMsg, Deconstruct
 */
public class TxnP4113 extends TxnMain {
    // log4J category
    ...
    private static final String MsgFunCode = InterCitiPinChange_MsgCode;
    ...
    public TxnP4113(String TerminalID, String msgSeq) {
    ...
    public ByteBuffer ConstructBBMsg() {
        ...
        iTempLen1 += iElementLen;
        {
            ...
            iTempLen2 += iElementLen;
            {
                 ...
                 * 
                 * //AuthTkn2 = "303130303032353030363136343730313145313232313133373136313220"; iElementLen = 4 + (AuthTkn3.length()/2); sbSendMsg.append(sAuthTkn_S_ID);
                 * sbSendMsg.append(Misc.padZero(Integer.toHexString(iElementLen),iPadZeroLen)); sbSendMsg.append(AuthTkn3); iTempLen1 += iElementLen; iTempLen2 += iElementLen; iTempLen3 +=
                 * iElementLen; iTempLen4 += iElementLen; } sbSendMsg.insert(iKeepPoint4, Misc.padZero(Integer.toHexString(4 + iTempLen4),iPadZeroLen)); iTempLen4 = 0;
                 */
                iElementLen = 4 + 2;
    ...
    public static void main(String[] args) {
        ...
        TxnP4113 txn = new TxnP4113("8614", "00000001");
        txn.ConstructBBMsg();
