...
public interface ImportFileService {
    ...
    List runSP(String[] importFiles, String[] storedProcedureNames);
    
    List runSP(String importFile, String storedProcedureName);
    
    void test(String filePath, String fileName);
    
    Map importFileProcess(String filePath, String fileName, int days, String[] importFiles, String[] storedProcedureNames);
